...
@section('content')
    ...
    <form action="/admin/payments" method="POST" class="w-100 d-block">
       ...
       <button type="submit" class="btn btn-warning w-25 my-3 d-block mx-auto">دفع إشتراك</button>
       <a href="/admin/players" class="btn btn-danger text-light w-25 d-block mx-auto">إلغاء</a>
       </section> 
    </form>
